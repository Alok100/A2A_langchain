...
| **PNG images** | Run `python make_architecture_diagram.py` from this folder. Generates: `architecture_spec.png`, `architecture.png`, `hr_decision_graph.png`, `policy_ingestion_graph.png`. |
